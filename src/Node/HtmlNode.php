...
class HtmlNode {
	 ...
	 * @see select()
	 */
	var $selectClass = 'Graal\Bone\Selector\HtmlSelector';
	/**
	 ...
	 * @see setInnerText()
	 */
	var $parserClass = 'Graal\Bone\Parser\HtmlParserHtml5';
	 ...
	 * @var string
	 */
	var $childClass_Text = 'Graal\Bone\Node\HtmlNodeText';
	/**
	 * Name of the class used for {@link addComment()}
	 * @var string
	 */
	var $childClass_Comment = 'Graal\Bone\Node\HtmlNodeComment';
	/**
	 * Name of the class used for {@link addContional()}
	 * @var string
	 */
	var $childClass_Conditional = 'Graal\Bone\Node\HtmlNodeConditional';
	/**
	 * Name of the class used for {@link addCDATA()}
	 * @var string
	 */
	var $childClass_CDATA = 'Graal\Bone\Node\HtmlNodeCDATA';
	/**
	 * Name of the class used for {@link addDoctype()}
	 * @var string
	 */
	var $childClass_Doctype = 'Graal\Bone\Node\HtmlNodeDoctype';
	/**
	 * Name of the class used for {@link addXML()}
	 * @var string
	 */
	var $childClass_XML = 'Graal\Bone\Node\HtmlNodeXML';
	/**
	 * Name of the class used for {@link addASP()}
	 * @var string
	 */
	var $childClass_ASP = 'Graal\Bone\Node\HtmlNodeASP';
	...
	#function HtmlNode($tag, $parent) {return $this->__construct($tag, $parent);}
	#php4e
	 ...
	 * @param HtmlNode|string $tag Match against parent, string to match tag, object to fully match node, null to return if node has parent
	 ...
	 * @param HtmlNode|string $tag Match against parent, string to match tag, object to fully match node
	 * @param bool $recursive
	 * @return bool
	 * @see hasParent()
	 */
